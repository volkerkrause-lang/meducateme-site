...
VOICE = os.getenv("GEMINI_TTS_VOICE", "Algenib")
...
def main():
    ...
    for index, stage in enumerate(spec["stages"], start=1):
        ...
        prompt = (
            ...
            "Director's notes: Read the transcript exactly as written. Keep the delivery natural, "
            "thoughtful and conversational, as if teaching one person at a whiteboard. Use short pauses "
            "after questions and before important reveals. Do not add words, sound effects, sighs, laughs, "
